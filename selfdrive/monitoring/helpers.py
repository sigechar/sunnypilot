...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self, device_type):
    ...
    self._AWARENESS_TIME = 1. # passive wheeltouch total timeout
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 0.5
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 0.25
    self._DISTRACTED_TIME = 1. # active monitoring total timeout
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 0.5
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 0.25
