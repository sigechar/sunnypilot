...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self, device_type):
    ...
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 1000
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 500
    self._DISTRACTED_TIME = 99999. # active monitoring total timeout
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 1000
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 500
